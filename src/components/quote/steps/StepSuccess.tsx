...
export function StepSuccess({ firstName, onClose }: StepSuccessProps) {
  return (
    <div className="flex flex-col items-center gap-5 py-4 text-center">
      ...
      <div>
        <h3 className="text-3xl font-semibold text-ink">You're All Set{firstName ? `, ${firstName}` : ""}.</h3>
      ...
      <div className="flex w-full flex-col gap-3 pt-2 sm:flex-row sm:justify-center">
        ...
        <Button onClick={onClose} variant="ghost" icon="none" className="w-full sm:w-auto">
          Close
        </Button>
      </div>
    </div>
